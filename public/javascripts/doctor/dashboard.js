const clinAlert = document
  ...
  const filteredClinic = document.getElementById('select_cinic');
...
function newLoop(){
    ...
    {
        changeNew.innerHTML = 'Nothing to show.'
    }
}
...
function todayLoop(){
    ...
    {
        changeToday.innerHTML = 'Nothing to show.'
    }
}
...
function tomorrowLoop(){
    ...
    {
        changeTomorrow.innerHTML = 'Nothing to show.'
    }
}
...
function laterLoop(){
    ...
    {
        changeLater.innerHTML = 'Nothing to show.'
    }
}
